				...
				<header id="header">
					...
					<nav id="nav">
						<ul>
							...
							<li class="current"><a href="InboxEncrypt.jsp">INBOX</a></li>
							<li class="current"><a href="ImageGeneration.jsp">IMAGE GENERATION</a></li>
							
							
							<li class="current"><a href="Log-Out.jsp" >Log-Out</a></li>
						</ul>
					</nav>
				</header>
