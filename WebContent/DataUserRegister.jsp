...
<html >
  <head>
    <meta charset="UTF-8">
    <title>Data User Register Form</title>
...
<!-- Pen Title-->
<div class="pen-title">
  <h1>Data User Register Form</h1><span><a href="DataOwnerLoginPage">Sign in</a>  &&  <a href="index.jsp">Home Page</a></span>
</div>
<!-- Form Module-->
<div class="module form-module">
  ...
  <div class="form">
    ...
    <form  action="DataUserRegister" method="post" name="myform" onsubmit="return validateform()" enctype="multipart/form-data">
